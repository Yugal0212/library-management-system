...
export default function MyFinesPage() {
  ...
  const totalPending = pendingFines.reduce((sum, fine) => sum + (Number(fine.amount) || 0), 0)
  const totalPaid = paidFines.reduce((sum, fine) => sum + (Number(fine.amount) || 0), 0)
  const totalWaived = waivedFines.reduce((sum, fine) => sum + (Number(fine.amount) || 0), 0)
      ...
      <div className="space-y-6">
        ...
        {totalPending > 0 && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              You have ${(Number(totalPending) || 0).toFixed(2)} in unpaid fines. Please contact the library to arrange payment.
            </AlertDescription>
          </Alert>
        )}
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-red-600">${(Number(totalPending) || 0).toFixed(2)}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600">${(Number(totalPaid) || 0).toFixed(2)}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">${(Number(totalWaived) || 0).toFixed(2)}</p>
                </div>
                        ...
                        <div key={fine.id} className="flex items-center justify-between p-4 bg-red-50 border border-red-200 rounded-lg">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className="font-medium text-red-900">${(Number(fine.amount) || 0).toFixed(2)}</span>
                        ...
                        <div key={fine.id} className="flex items-center justify-between p-4 bg-green-50 border border-green-200 rounded-lg">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className="font-medium text-green-900">${(Number(fine.amount) || 0).toFixed(2)}</span>
                        ...
                        <div key={fine.id} className="flex items-center justify-between p-4 bg-blue-50 border border-blue-200 rounded-lg">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className="font-medium text-blue-900">${(Number(fine.amount) || 0).toFixed(2)}</span>
